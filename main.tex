...
\subsection*{Sublime}
\lstinputlisting{codes/sublime.build}
...
\lstinputlisting{codes/NT_PR.cpp}
...
\lstinputlisting{codes/G_CD.cpp}
\subsection{Heavy Light Decomposition}
\lstinputlisting{codes/G_HLD.cpp}
\subsection{Mo's Algorithm} 
\lstinputlisting{codes/G_Mo.cpp}
...
\subsection{KMP}
\lstinputlisting{codes/S_KMP.cpp}
\subsection{Z Function}
\lstinputlisting{codes/S_Z.cpp}
\subsection{String Trie}
\lstinputlisting{codes/S_trie.cpp}
\subsection{XOR Trie}
\lstinputlisting{codes/S_xortrie.cpp}
\subsection{Robin Karp}
\lstinputlisting{codes/S_RK.cpp}
\subsection{Manacher}
\lstinputlisting{codes/S_manacher.cpp}
...
\section{DP}
\subsection{DnC} 
\lstinputlisting{codes/DP_DnC.cpp}
\subsection{Knuth's Optimization}
\lstinputlisting{codes/DP_knuth.cpp}
\subsection{Parquet Problem}
\lstinputlisting{codes/DP_parquet.cpp}
\subsection{Convex Hull Optimization}
\lstinputlisting{codes/DP_CH.cpp}
